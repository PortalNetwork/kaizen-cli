  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return ExecuteCommand('npm install @nervosnetwork/ckb-sdk-core');

        case 2:
          _context.next = 4;
          return ExecuteCommand('npm install @nervosnetwork/ckb-sdk-rpc');

        case 4:
          _context.next = 6;
          return ExecuteCommand('npm install @nervosnetwork/ckb-sdk-utils');
